...
SQLAgent_schema = {
    "name": "SQLAgent",
    "description": "You are a helpful assistant. Your role is to pass user message to get final SQL query as response. Do not modify the query",
    "parameters": {
        "type": "object",
        "properties": {
            "query": {
                "type": "string",
                "description": "A user message to SQLAgent"
            }
        },
        "required": ["query"]
    }
...
class Planner:
    def __init__(self, base_model: str):
        ...
        self.agent = AssistantAgent(name="SQLAgent",
                                  llm_config=llm_config,
                                  code_execution_config=False,
                                  max_consecutive_auto_reply=1,
                                #   function_map={"SQLAgent": SQLAgent},
                                  default_auto_reply= "Recruiter agent error",)
